    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Create your account or access the admin portal</p>
        </div>
        ...
        {role === "citizen" ? (
          ...
          >
            <div className="text-center pb-1">
              ...
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Administrator Access</h2>
              <p className="text-gray-500 dark:text-gray-400 text-xs mt-1">
                Administrators are created centrally. Self-service registration is not available.
                Sign in with your issued credentials below.
              </p>
            </div>
            ...
            <div className="pt-3 border-t border-[#E5E7EB] dark:border-gray-700 space-y-2 text-center">
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500">
                ...
                <Link href="/sign-in" className="text-[#8EC5FC] hover:underline font-medium">
                  Go to Sign In
                </Link>
              </p>
            </div>

...
export default function SignInPage() {
  ...
  const handleCitizenMockLogin = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    try {
        ...
        {role === "citizen" ? (
          ...
          >
            {isClerkLive ? (
              ...
              <form
                onSubmit={handleCitizenMockLogin}
              ...
              >
                <div className="text-center pb-1">
                  ...
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Citizen Sign In</h2>
                  <p className="text-gray-500 dark:text-gray-400 text-xs mt-1">Local Mock Authentication Mode</p>
                </div>
